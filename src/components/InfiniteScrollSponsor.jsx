...
const InfiniteScrollSponsors = () => {
  const [displayedSponsors, setDisplayedSponsors] = useState(sponsorLogos.slice(0, 6));
  ...
  return (
    <div className="sponsor-list p-4">
      <h2 className="text-center text-3xl font-bold mb-6 text-blue-800">Our Sponsors</h2>
      <div className="overflow-x-auto flex space-x-6 pb-4"> {/* Wrapper untuk scroll horizontal */}
